...
{
    public class CommodityCustomerController : AppBaseController
    {
        #region Constructor

        private readonly ICommodityCustomerService _customerService;

        public CommodityCustomerController(ICommodityCustomerService customerService)
        {
        ...
        #region Insrt into CommodityCustomer
