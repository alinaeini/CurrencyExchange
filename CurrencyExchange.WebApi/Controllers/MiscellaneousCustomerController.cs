...
{
    public class MiscellaneousCustomerController : AppBaseController
    {
        #region Constructor

        private readonly IMiscellaneousCustomerService _customerService;

        public MiscellaneousCustomerController(IMiscellaneousCustomerService customerService)
        {
        ...
        #region Create MiscellaneousCustomer

        [HttpPost("create")]
        public async Task<IActionResult> CreateMiscellaneousCustomer([FromBody] CreateCustomerDto customer)
        {
