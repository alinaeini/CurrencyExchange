...
namespace CurrencyExchange.Infrastructure.Migrations
{
    ...
    [Migration("20210207112055_CreateDb3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Access.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6063),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6096),
                            Name = "Admin",
                            Title = "راهبر سیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6175),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6182),
                            Name = "Manager",
                            Title = "مدیر سیستم"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6188),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6192),
                            Name = "Fnc",
                            Title = "کاربر مالی "
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6198),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 554, DateTimeKind.Local).AddTicks(6202),
                            Name = "Bsn",
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Broker.Broker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 548, DateTimeKind.Local).AddTicks(5023),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 552, DateTimeKind.Local).AddTicks(2236),
                        ...
                        new
                        {
                            Id = 2L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 2, 7, 14, 50, 54, 552, DateTimeKind.Local).AddTicks(5039),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 50, 54, 552, DateTimeKind.Local).AddTicks(5080),
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Access.UserRolePermission", b =>
                {
                    b.HasOne("CurrencyExchange.Domain.EntityModels.Access.Permission", "MenuItem")
