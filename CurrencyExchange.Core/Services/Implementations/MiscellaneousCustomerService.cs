...
{
    public class MiscellaneousCustomerService : IMiscellaneousCustomerService
    {
        #region Costructor

        private IMiscellaneousCustomerRepository miscellaneousCustomerRepository;
        ...
        {
            var isExist = miscellaneousCustomerRepository.IsNameExist(customerDto.Name.Trim().ToLower());
            if (isExist)
                return CustomerResult.CustomerIsExist;
            var customer = new MiscellaneousCustomer()
            {
            ...
            await miscellaneousCustomerRepository.AddEntity(customer);
            await miscellaneousCustomerRepository.SaveChanges();
        ...
        {
            var cuastomerList = miscellaneousCustomerRepository.GetEntities().AsQueryable();
        ...
        {
            var customer = await miscellaneousCustomerRepository.GetEntityById(id);
            if (customer == null)
            {
                return null;
            }
        ...
        public async Task<List<CustomerDto>> GetCustomers()
        {
            ...
            var customers = await miscellaneousCustomerRepository.GetEntities().ToListAsync();
            if (customers != null)
            {
        ...
        {
            var customer = await miscellaneousCustomerRepository.GetEntityById(customerDto.Id);
            if (customer == null)
            ...
            miscellaneousCustomerRepository.UpdateEntity(customer);
            await miscellaneousCustomerRepository.SaveChanges();
            return CustomerResult.Success;
        }
        ...
        {
            await miscellaneousCustomerRepository.RemoveEntity(Id);
            await miscellaneousCustomerRepository.SaveChanges();
            return CustomerResult.Success;
        }
        ...
        public void Dispose()
        {
            this.miscellaneousCustomerRepository?.Dispose();
        }
