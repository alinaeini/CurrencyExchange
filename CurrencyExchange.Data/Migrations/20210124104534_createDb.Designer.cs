...
namespace CurrencyExchange.Data.Migrations
{
    ...
    [Migration("20210124104534_createDb")]
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Access.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1187),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1212),
                            Name = "Admin",
                            Title = "راهبر سیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1292),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1300),
                            Name = "Manager",
                            Title = "مدیر سیستم"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1306),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1310),
                            Name = "Fnc",
                            Title = "کاربر مالی "
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1314),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 331, DateTimeKind.Local).AddTicks(1318),
                            Name = "Bsn",
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Broker.Broker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 324, DateTimeKind.Local).AddTicks(216),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 328, DateTimeKind.Local).AddTicks(8051),
                        ...
                        new
                        {
                            Id = 2L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 1, 24, 14, 15, 33, 329, DateTimeKind.Local).AddTicks(1197),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 24, 14, 15, 33, 329, DateTimeKind.Local).AddTicks(1239),
