...
namespace CurrencyExchange.Data.Migrations
{
    ...
    [Migration("20210125135119_addbrokeramount")]
    partial class addbrokeramount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Access.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9579),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9616),
                            Name = "Admin",
                            Title = "راهبر سیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9708),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9717),
                            Name = "Manager",
                            Title = "مدیر سیستم"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9724),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9729),
                            Name = "Fnc",
                            Title = "کاربر مالی "
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9735),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 375, DateTimeKind.Local).AddTicks(9740),
                            Name = "Bsn",
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Broker.Broker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Address = "ندارد",
                            AmountBalanceBroker = 0L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 368, DateTimeKind.Local).AddTicks(6594),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 373, DateTimeKind.Local).AddTicks(4844),
                        ...
                        new
                        {
                            ...
                            Address = "ندارد",
                            AmountBalanceBroker = 0L,
                            CreateDate = new DateTime(2021, 1, 25, 17, 21, 18, 373, DateTimeKind.Local).AddTicks(7959),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 1, 25, 17, 21, 18, 373, DateTimeKind.Local).AddTicks(8008),
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Sales.CurrencySaleDetailExDec", b =>
                {
                    b.HasOne("CurrencyExchange.Domain.EntityModels.Sales.CurrencySale", null)
