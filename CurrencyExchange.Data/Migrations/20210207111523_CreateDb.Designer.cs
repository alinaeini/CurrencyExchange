...
namespace CurrencyExchange.Infrastructure.Migrations
{
    ...
    [Migration("20210207111523_CreateDb")]
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Access.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(8986),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9012),
                            Name = "Admin",
                            Title = "راهبر سیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9087),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9094),
                            Name = "Manager",
                            Title = "مدیر سیستم"
                        },
                        new
                        {
                            Id = 3L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9100),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9104),
                            Name = "Fnc",
                            Title = "کاربر مالی "
                        },
                        new
                        {
                            Id = 4L,
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9108),
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 164, DateTimeKind.Local).AddTicks(9112),
                            Name = "Bsn",
            ...
            modelBuilder.Entity("CurrencyExchange.Domain.EntityModels.Broker.Broker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 158, DateTimeKind.Local).AddTicks(5946),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 162, DateTimeKind.Local).AddTicks(7633),
                        ...
                        new
                        {
                            Id = 2L,
                            Address = "ندارد",
                            CreateDate = new DateTime(2021, 2, 7, 14, 45, 23, 163, DateTimeKind.Local).AddTicks(373),
                            Description = "ندارد",
                            IsActive = true,
                            IsDelete = false,
                            LastUpdateDate = new DateTime(2021, 2, 7, 14, 45, 23, 163, DateTimeKind.Local).AddTicks(414),
